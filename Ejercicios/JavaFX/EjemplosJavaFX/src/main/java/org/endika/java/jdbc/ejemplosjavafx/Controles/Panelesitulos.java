...
public class Panelesitulos extends Application {
    ...
    public void start(Stage escenarioPrincipal) {
        try {
            ...
            Image logo1 = new Image(getClass().getResourceAsStream("/imagenes/iconoCerveza.png"), 200, 200, true, true);
            Image logo2 = new Image(getClass().getResourceAsStream("/imagenes/iconoApagar.png"), 200, 200, true, true);
